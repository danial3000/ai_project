...
class MiniMax:
    ...
    def utility_function(self, grid, num_actions):
        ...
        utility = (
                ...
                2 * hen_to_endpoint + # proximity to endpoint
                1 * hen_to_eggs - # proximity to eggs
                1 * hen_to_pigs -  # proximity to eggs
                1 * num_actions + # number of actions
                1 * hen_score + # number of eggs eaten by the hen
